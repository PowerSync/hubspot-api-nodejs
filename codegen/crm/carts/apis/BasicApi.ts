...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param cartsId
     */
    public async archive(cartsId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'cartsId' is not null or undefined
        if (cartsId === null || cartsId === undefined) {
            throw new RequiredError("BasicApi", "archive", "cartsId");
        }


        // Path Params
        const localVarPath = '/crm/v3/objects/carts/{cartsId}'
            .replace('{' + 'cartsId' + '}', encodeURIComponent(String(cartsId)));
    ...
    public async create(simplePublicObjectInputForCreate: SimplePublicObjectInputForCreate, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/crm/v3/objects/carts';
     ...
     */
    public async getById(cartsId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'cartsId' is not null or undefined
        if (cartsId === null || cartsId === undefined) {
            throw new RequiredError("BasicApi", "getById", "cartsId");
        }
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public async update(cartsId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'cartsId' is not null or undefined
        if (cartsId === null || cartsId === undefined) {
            throw new RequiredError("BasicApi", "update", "cartsId");
        }
