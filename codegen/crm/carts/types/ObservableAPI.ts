...
export class ObservableBasicApi {
    ...
    /**
     * Move an Object identified by `{cartsId}` to the recycling bin.
     * Archive
     * @param cartsId
     */
    public archiveWithHttpInfo(cartsId: string, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.archive(cartsId, _options);
     ...
     * @param cartsId
     */
    public archive(cartsId: string, _options?: Configuration): Observable<void> {
        return this.archiveWithHttpInfo(cartsId, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }

    /**
     * Create a carts with the given properties and return a copy of the object, including the ID. Documentation and examples for creating standard carts is provided.
     * Create
    ...
    /**
     * Read an Object identified by `{cartsId}`. `{cartsId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param.  Control what is returned via the `properties` query param.
     * Read
     * @param cartsId
     ...
     */
    public getByIdWithHttpInfo(cartsId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObjectWithAssociations>> {
        const requestContextPromise = this.requestFactory.getById(cartsId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public getById(cartsId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
        return this.getByIdWithHttpInfo(cartsId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe(map((apiResponse: HttpInfo<SimplePublicObjectWithAssociations>) => apiResponse.data));
    }
    ...
    /**
     * Perform a partial update of an Object identified by `{cartsId}`. `{cartsId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
     * Update
     * @param cartsId
     * @param simplePublicObjectInput
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public updateWithHttpInfo(cartsId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>> {
        const requestContextPromise = this.requestFactory.update(cartsId, simplePublicObjectInput, idProperty, _options);
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public update(cartsId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<SimplePublicObject> {
        return this.updateWithHttpInfo(cartsId, simplePublicObjectInput, idProperty, _options).pipe(map((apiResponse: HttpInfo<SimplePublicObject>) => apiResponse.data));
    }
...
export class ObservablePublicObjectApi {
    ...
    /**
     * Merge two carts with same type
