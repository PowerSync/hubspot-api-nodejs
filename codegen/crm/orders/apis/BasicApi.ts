...
export class BasicApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param ordersId
     */
    public async archive(ordersId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'ordersId' is not null or undefined
        if (ordersId === null || ordersId === undefined) {
            throw new RequiredError("BasicApi", "archive", "ordersId");
        }
     ...
     */
    public async getById(ordersId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'ordersId' is not null or undefined
        if (ordersId === null || ordersId === undefined) {
            throw new RequiredError("BasicApi", "getById", "ordersId");
        }
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public async update(ordersId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'ordersId' is not null or undefined
        if (ordersId === null || ordersId === undefined) {
            throw new RequiredError("BasicApi", "update", "ordersId");
        }
