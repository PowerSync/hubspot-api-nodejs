...
export class ObservableBasicApi {
    ...
    /**
     * Move an Object identified by `{ordersId}` to the recycling bin.
     * Archive
     * @param ordersId
     */
    public archiveWithHttpInfo(ordersId: string, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.archive(ordersId, _options);
     ...
     * @param ordersId
     */
    public archive(ordersId: string, _options?: Configuration): Observable<void> {
        return this.archiveWithHttpInfo(ordersId, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
    ...
    /**
     * Read an Object identified by `{ordersId}`. `{ordersId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param.  Control what is returned via the `properties` query param.
     * Read
     * @param ordersId
     ...
     */
    public getByIdWithHttpInfo(ordersId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObjectWithAssociations>> {
        const requestContextPromise = this.requestFactory.getById(ordersId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public getById(ordersId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations> {
        return this.getByIdWithHttpInfo(ordersId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe(map((apiResponse: HttpInfo<SimplePublicObjectWithAssociations>) => apiResponse.data));
    }
    ...
    /**
     * Perform a partial update of an Object identified by `{ordersId}`. `{ordersId}` refers to the internal object ID by default, or optionally any unique property value as specified by the `idProperty` query param. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
     * Update
     * @param ordersId
     * @param simplePublicObjectInput
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public updateWithHttpInfo(ordersId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>> {
        const requestContextPromise = this.requestFactory.update(ordersId, simplePublicObjectInput, idProperty, _options);
     ...
     * @param idProperty The name of a property whose values are unique for this object type
     */
    public update(ordersId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<SimplePublicObject> {
        return this.updateWithHttpInfo(ordersId, simplePublicObjectInput, idProperty, _options).pipe(map((apiResponse: HttpInfo<SimplePublicObject>) => apiResponse.data));
    }
